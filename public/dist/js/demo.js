...
(function ($) {
  ...
  var $dropdown_legacy_offset_checkbox = $('<input />', {
    type: 'checkbox',
    value: 1,
    checked: $('.posts-header').hasClass('dropdown-legacy'),
    class: 'mr-1'
  }).on('click', function () {
    if ($(this).is(':checked')) {
      $('.posts-header').addClass('dropdown-legacy')
    } else {
      $('.posts-header').removeClass('dropdown-legacy')
    }
  })
  ...
  var $no_border_checkbox = $('<input />', {
    type: 'checkbox',
    value: 1,
    checked: $('.posts-header').hasClass('border-bottom-0'),
    class: 'mr-1'
  }).on('click', function () {
    if ($(this).is(':checked')) {
      $('.posts-header').addClass('border-bottom-0')
    } else {
      $('.posts-header').removeClass('border-bottom-0')
    }
  })
  ...
  var $no_expand_sidebar_checkbox = $('<input />', {
    type: 'checkbox',
    value: 1,
    checked: $('.posts-sidebar').hasClass('sidebar-no-expand'),
    class: 'mr-1'
  }).on('click', function () {
    if ($(this).is(':checked')) {
      $('.posts-sidebar').addClass('sidebar-no-expand')
    } else {
      $('.posts-sidebar').removeClass('sidebar-no-expand')
    }
  })
  ...
  var $text_sm_header_checkbox = $('<input />', {
    type: 'checkbox',
    value: 1,
    checked: $('.posts-header').hasClass('text-sm'),
    class: 'mr-1'
  }).on('click', function () {
    if ($(this).is(':checked')) {
      $('.posts-header').addClass('text-sm')
    } else {
      $('.posts-header').removeClass('text-sm')
    }
  })
  ...
  var $text_sm_footer_checkbox = $('<input />', {
    type: 'checkbox',
    value: 1,
    checked: $('.posts-footer').hasClass('text-sm'),
    class: 'mr-1'
  }).on('click', function () {
    if ($(this).is(':checked')) {
      $('.posts-footer').addClass('text-sm')
    } else {
      $('.posts-footer').removeClass('text-sm')
    }
  })
  ...
  $('.posts-header')[0].classList.forEach(function (className) {
  ...
  $('.posts-sidebar')[0].classList.forEach(function (className) {
